public class TranslateToLogic10 extends LogicQuestion
{
   int qNumber;
   
   public TranslateToLogic10(String [] statements, int questionNumber)
   {
   ...
   public String generate()
   {
      ...
      str.append(String.format("%s %s %s %s %s %s %s %s %s", "<questiontext format='html'> <text><![CDATA[<p dir='ltr' style='text-align: left;'><strong>Let P represent \"" + getP() + "\", let Q represent \"" + getQ() + "\" and let R represent \"" + getR() + "\". <p>Select the symbolic form that best represents the compound statement below.</p>", "</strong><p>", "if", getP(), "and", getQ(), "then", getNegation(getR()),"</p>]]></text> </questiontext>"));
   ...
   public static void main(String[] args)
   {
      ...
      TranslateToLogic10 question = new TranslateToLogic10(array, 1);
