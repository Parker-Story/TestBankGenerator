public class TranslateToLogic2 extends LogicQuestion
{
   int qNumber;
   
   public TranslateToLogic2(String [] statements, int questionNumber)
   {
   ...
   public String generate()
   {
      ...
      str.append(String.format("%s %s %s %s %s %s %s\n", "<p dir='ltr' style='text-align: left;'>Consider the statement below.</p><p><strong>", getNegation(getP()), "and, either", getQ(), "or", getR(),"</strong></p>"));
   ...
   public static void main(String[] args)
   {
      ...
      TranslateToLogic2 question = new TranslateToLogic2(array, 1);
