public class TranslateToLogic3 extends LogicQuestion
{
   int qNumber;
   
   public TranslateToLogic3(String [] statements, int questionNumber)
   {
   ...
   public static void main(String[] args)
   {
      ...
      TranslateToLogic3 question = new TranslateToLogic3(array, 1);
