public class TranslateToLogic1 extends LogicQuestion
{
   int qNumber;
   
   public TranslateToLogic1(String [] statements, int questionNumber)
   {
   ...
   public static void main(String[] args)
   {
      ...
      TranslateToLogic1 question = new TranslateToLogic1(array, 1);
