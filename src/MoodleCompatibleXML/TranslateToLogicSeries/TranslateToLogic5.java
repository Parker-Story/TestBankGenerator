public class TranslateToLogic5 extends LogicQuestion
{
   int qNumber;
   
   public TranslateToLogic5(String [] statements, int questionNumber)
   {
   ...
   public String generate()
   {
      ...
      str.append(String.format("%s %s %s %s %s %s %s %s\n", "<p dir='ltr' style='text-align: left;'>Consider the statement below.</p><p><strong>","Either", getP(), "or,", getNegation(getQ()),"and", getR(), "</strong></p>"));
   ...
   public static void main(String[] args)
   {
      ...
      TranslateToLogic5 question = new TranslateToLogic5(array, 1);
