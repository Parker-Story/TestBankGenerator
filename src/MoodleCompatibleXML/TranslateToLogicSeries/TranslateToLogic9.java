public class TranslateToLogic9 extends LogicQuestion
{
   int qNumber;
   
   public TranslateToLogic9(String [] statements, int questionNumber)
   {
   ...
   public static void main(String[] args)
   {
      ...
      TranslateToLogic9 question = new TranslateToLogic9(array, 1);
