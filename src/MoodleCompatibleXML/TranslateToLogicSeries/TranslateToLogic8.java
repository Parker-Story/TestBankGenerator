public class TranslateToLogic8 extends LogicQuestion
{
   int qNumber;
   
   public TranslateToLogic8(String [] statements, int questionNumber)
   {
   ...
   public static void main(String[] args)
   {
      ...
      TranslateToLogic8 question = new TranslateToLogic8(array, 1);
