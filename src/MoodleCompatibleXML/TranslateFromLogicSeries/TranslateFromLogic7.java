public class TranslateFromLogic7 extends LogicQuestion
{
   int qNumber;
   
   public TranslateFromLogic7(String [] statements, int questionNumber)
   {
   ...
   public String generate()
   {
      ...
      str.append(String.format("%s %s %s %s %s\n", "<p dir='ltr' style='text-align: left;'>Consider the statement below.</p><p><strong>", getNegation(getP()), "and", getQ(), "</strong></p>"));
   ...
   public static void main(String[] args)
   {
      ...
      TranslateFromLogic7 question = new TranslateFromLogic7(array, 1);
