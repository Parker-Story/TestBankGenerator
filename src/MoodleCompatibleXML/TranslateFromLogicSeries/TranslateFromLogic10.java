public class TranslateFromLogic10 extends LogicQuestion
{
   int qNumber;
   
   public TranslateFromLogic10(String [] statements, int questionNumber)
   {
   ...
   public String generate()
   {
      ...
      str.append(String.format("%s %s %s %s %s %s %s\n", "<p dir='ltr' style='text-align: left;'>Consider the statement below.</p><p><strong>", getP(), "and,", getQ(), "or", getNegation(getR()), "</strong></p>"));
   ...
   public static void main(String[] args)
   {
      ...
      TranslateFromLogic10 question = new TranslateFromLogic10(array, 1);
