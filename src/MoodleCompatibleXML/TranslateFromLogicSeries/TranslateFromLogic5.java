public class TranslateFromLogic5 extends LogicQuestion
{
   int qNumber;
   
   public TranslateFromLogic5(String [] statements, int questionNumber)
   {
   ...
   public static void main(String[] args)
   {
      ...
      TranslateFromLogic5 question = new TranslateFromLogic5(array, 1);
