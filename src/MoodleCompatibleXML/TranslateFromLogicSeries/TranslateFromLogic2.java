public class TranslateFromLogic2 extends LogicQuestion
{
   int qNumber;
   
   public TranslateFromLogic2(String [] statements, int questionNumber)
   {
   ...
   public static void main(String[] args)
   {
      ...
      TranslateFromLogic2 question = new TranslateFromLogic2(array, 1);
