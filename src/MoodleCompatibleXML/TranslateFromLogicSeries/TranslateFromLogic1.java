public class TranslateFromLogic1 extends LogicQuestion
{
   int qNumber;
   
   public TranslateFromLogic1(String [] statements, int questionNumber)
   {
   ...
   public String generate()
   {
      ...
      str.append(String.format("%s %s %s\n", "<p dir='ltr' style='text-align: left;'>Consider the logic expression below.</p><p><strong>", "P &and; Q", "</strong></p>"));
      ...
      str.append(String.format("%s\n%s\n%s\n%s\n %s %s %s %s %s %s", "<answer fraction=\"0\" format=\"html\">",
                    ...
                    "<feedback><text></text></feedback>",
                     "</answer>"));
      str.append(String.format("%s\n%s\n%s\n%s\n%s %s %s %s", "<answer fraction=\"100\" format=\"html\">",
   ...
   public static void main(String[] args)
   {
      ...
      TranslateFromLogic1 question = new TranslateFromLogic1(array, 1);
