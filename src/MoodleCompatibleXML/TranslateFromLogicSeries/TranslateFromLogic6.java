public class TranslateFromLogic6 extends LogicQuestion
{
   int qNumber;
   
   public TranslateFromLogic6(String [] statements, int questionNumber)
   {
   ...
   public String generate()
   {
      ...
      str.append(String.format("%s %s %s %s %s\n", "<p dir='ltr' style='text-align: left;'>Consider the statement below.</p><p><strong>", getP(), "and", getQ(), "</strong></p>"));
   ...
   public static void main(String[] args)
   {
      ...
      TranslateFromLogic6 question = new TranslateFromLogic6(array, 1);
