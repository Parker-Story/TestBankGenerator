public class TranslateFromLogic8 extends LogicQuestion
{
   int qNumber;
   
   public TranslateFromLogic8(String [] statements, int questionNumber)
   {
   ...
   public String generate()
   {
      ...
      str.append(String.format("%s %s %s %s %s %s %s\n", "<p dir='ltr' style='text-align: left;'>Consider the statement below.</p><p><strong>", getP(), "and,", getQ(), "or", getR(), "</strong></p>"));
   ...
   public static void main(String[] args)
   {
      ...
      TranslateFromLogic8 question = new TranslateFromLogic8(array, 1);
