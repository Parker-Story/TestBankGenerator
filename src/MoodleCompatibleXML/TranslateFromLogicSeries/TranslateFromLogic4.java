public class TranslateFromLogic4 extends LogicQuestion
{
   int qNumber;
   
   public TranslateFromLogic4(String [] statements, int questionNumber)
   {
   ...
   public String generate()
   {
      ...
      str.append(String.format("%s %s %s\n", "<p dir='ltr' style='text-align: left;'>Consider the logic expression below.</p><p><strong>", "~P &or; (Q &and; R)", "</strong></p>"));
   ...
   public static void main(String[] args)
   {
      ...
      TranslateFromLogic4 question = new TranslateFromLogic4(array, 1);
